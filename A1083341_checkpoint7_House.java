...
public class A1083341_checkpoint7_House extends JLabel implements Runnable {
    ...
    A1083341_checkpoint7_GameFrame parentFrame;
    ...
    public A1083341_checkpoint7_House(int locationX, int locationY, String text, int scaler, int horizontalAlignment) {
